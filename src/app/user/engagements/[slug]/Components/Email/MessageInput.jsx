  ...
  const handleScheduleMessage = () => {
    schedulingForm.validateFields().then(values => {
      ...
      message.success(
        <Space>
          <ScheduleOutlined />
          <span>Message scheduled for {combinedDateTime.format('MMM D, YYYY [at] h:mm A')}</span>
        </Space>
      );
  ...
  return (
    <>
      ...
      >
        ...
        <Tooltip title={scheduledTime ? "Schedule for " + dayjs(scheduledTime).format('MMM D, h:mm A') : "Send now"}>
          <Button 
            type="primary" 
            shape="circle" 
      ...
      >
        ...
        >
          ...
          <Form.Item
            ...
            initialValue={getDefaultScheduleTime()}
          >
            <TimePicker 
              style={{ width: '100%' }} 
              format="HH:mm"
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            >
              {messageText || <Text type="secondary">(No message content)</Text>}
            </div>
          </div>
